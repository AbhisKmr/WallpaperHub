...
public class adventure extends AppCompatActivity {
    ...
    private final String JOSN_URL = "https://raw.githubusercontent.com/AbhisKmr/WallpaperHub/master/wallpaperHubAdventure.json";
    ...
    private void jsonrequest() {
        ...
        requestQueue  = Volley.newRequestQueue(adventure.this);
