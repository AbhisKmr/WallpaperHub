...
public class road extends AppCompatActivity {
    ...
    private final String JOSN_URL = "https://raw.githubusercontent.com/AbhisKmr/WallpaperHub/master/wallpaperHubRoad.json";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.roadRecycler);
        jsonrequest();
    ...
    private void jsonrequest() {
        ...
        requestQueue  = Volley.newRequestQueue(road.this);
