...
public class old extends AppCompatActivity {
    private final String JOSN_URL = "https://raw.githubusercontent.com/AbhisKmr/WallpaperHub/master/wallpaperHubOld.json";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.oldRecycler);
        jsonrequest();
    }
    private void jsonrequest() {
        ...
        requestQueue  = Volley.newRequestQueue(old.this);
