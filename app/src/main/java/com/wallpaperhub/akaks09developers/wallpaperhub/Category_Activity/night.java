...
public class night extends AppCompatActivity {
    private final String JOSN_URL = "https://raw.githubusercontent.com/AbhisKmr/WallpaperHub/master/wallpaperHubNight.json";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.nightRecycler);
        jsonrequest();
    }
    private void jsonrequest() {
        ...
        requestQueue  = Volley.newRequestQueue(night.this);
