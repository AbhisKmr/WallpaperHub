...
public class water extends AppCompatActivity {
    ...
    private final String JOSN_URL = "https://raw.githubusercontent.com/AbhisKmr/WallpaperHub/master/wallpaperHubWater.json";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.waterRecycler);
        jsonrequest();
    }
    private void jsonrequest() {
        ...
        requestQueue  = Volley.newRequestQueue(water.this);
