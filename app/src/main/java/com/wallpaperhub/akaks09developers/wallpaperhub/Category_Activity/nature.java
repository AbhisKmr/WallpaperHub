...
public class nature extends AppCompatActivity {
    ...
    private final String JOSN_URL = "https://raw.githubusercontent.com/AbhisKmr/WallpaperHub/master/wallpaperHubNature.json";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.natureRecycler);
        jsonrequest();
    }
    private void jsonrequest() {
        ...
        requestQueue  = Volley.newRequestQueue(nature.this);
