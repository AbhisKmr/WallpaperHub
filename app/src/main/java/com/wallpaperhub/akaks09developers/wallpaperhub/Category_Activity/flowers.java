...
public class flowers extends AppCompatActivity {
    private final String JOSN_URL = "https://raw.githubusercontent.com/AbhisKmr/WallpaperHub/master/wallpaperHubFlower.json";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.flowerRecycler);
        jsonrequest();
    ...
    private void jsonrequest() {
        ...
        requestQueue  = Volley.newRequestQueue(flowers.this);
