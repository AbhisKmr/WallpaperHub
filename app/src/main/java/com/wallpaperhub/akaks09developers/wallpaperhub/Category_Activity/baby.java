...
public class baby extends AppCompatActivity {
    ...
    private final String JOSN_URL = "https://raw.githubusercontent.com/AbhisKmr/WallpaperHub/master/wallpaperHubBaby.json";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.babyRecycler);
        jsonrequest();
    }
    private void jsonrequest() {
        ...
        requestQueue  = Volley.newRequestQueue(baby.this);
